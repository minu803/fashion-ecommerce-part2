...
export default function Footer() {
  ...
  // Retrieve the current path from the router
  const path = router.pathname;
  // Use the useContext hook to access the selectedProducts from ProductsContext
  const {selectedProducts} = useContext(ProductsContext);
  return (
    // Footer element with fixed positioning, styling, and layout properties
